    ...
    <div ref="containerRef" class="copy-page-container">
      <div class="copy-page-split-button">
        <button class="copy-main-btn" @click="copyPage">
          <svg v-if="copied" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="check-icon">
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" :class="{ rotated: showDropdown }">
      ...
      <Transition name="dropdown">
        <div v-if="showDropdown" class="copy-dropdown" role="menu">
          <button class="dropdown-item" role="menuitem" @click="copyPage">
            <svg class="dropdown-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
              <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
              <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
            </svg>
          ...
          <a class="dropdown-item" role="menuitem" :href="claudeUrl" target="_blank" rel="noopener" @click="showDropdown = false">
            <svg class="dropdown-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
          ...
          <a class="dropdown-item" role="menuitem" :href="chatgptUrl" target="_blank" rel="noopener" @click="showDropdown = false">
            <svg class="dropdown-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
          ...
          <a class="dropdown-item" role="menuitem" :href="markdownPath" target="_blank" rel="noopener" @click="showDropdown = false">
            <svg class="dropdown-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
